...
<!-- html -->
 <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Teachers Available</h4>                   
                ...
                $sql="SELECT * FROM teacher_record;";
                  ...
                  ?>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-secondary"><?php echo $row['email'];?></td> <td class="text-grey"><?php echo $row['phone'];?></td>
