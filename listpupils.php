...
<!-- html -->
 <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Pupils Available</h4>
                    <p class="card-description"> Deactivate/Activate
                    </p>
                  ...
                  ?>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td  class="text-secondary"><?php echo $row['PHONE'];?></td> <td>  <label class="badge badge-light"><?php echo $row['CODE'];?></td>
                          <td><!-- <label class="badge badge-light"> --><?php
                if($row['STATUS']==1){
                    echo '<a href="change.php?p_id='.$row['p_id'].'&STATUS=0" class="activate">
                          <button type="button" class="btn btn-outline-success btn-icon-text">
                            <i class="mdi mdi-account-star"></i> Activated </button></a>';
                }
                    else{
                        echo '<a href="change.php?p_id='.$row['p_id'].'&STATUS=1" class="deactivate"> <button type="button" class="btn btn-outline-danger btn-icon-text">
                            <i class="mdi mdi-account-remove"></i> Deactivated </button></a>';
                    }
                ?><!-- </label -->
              </td>
                        </tr>
