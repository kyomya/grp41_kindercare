...
<!-- html -->
 <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Pupil's Scores</h4>                   
          ...
          <td div class="form-group">
            <form method="POST" action="PHP/commentonscores.php">
<!--                         <label for="">Add comments here</label>
 -->                        <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                        <input type="text" name="comment" class="form-control" value="<?php echo $row['comment'];?>"  rows="4">
                        </form>
                      </div></td>
