...
<div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="PHP/teacher_new.php" class="forms-sample">
                      <div class="form-group row">
                        <label for="hisName" class="col-sm-3 col-form-label">First Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="tfname" placeholder="first name" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="hisName" class="col-sm-3 col-form-label">Last Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="tlname" placeholder="last name" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label">Email</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="temail" placeholder="@email" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="mobileNumber" class="col-sm-3 col-form-label">Mobile</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="tphone" placeholder="mobile number" required>
                        </div>

                      </div>
                      <div class="form-group row">
                        <label for="assignCode" class="col-sm-3 col-form-label">Teacher's code</label>
                        <div class="col-sm-9">
                          <input type="password" class="form-control" name="tcode" placeholder="assign code" required>
                        </div>
                      </div>

                      <button name="registerteacher" type="submit" class="btn btn-light mr-2">Add Teacher</button>
