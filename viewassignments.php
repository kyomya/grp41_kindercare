...
<div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Assignments Available</h4>
                    <p class="card-description"> Simple view
                    </p>
                ...
                while ($row=mysqli_fetch_array($result)) {
                  ?>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-dark"><?php echo $row['characters'];?></td>
                          <td class="text-dark"><?php echo $row['assigned_marks'];?></td>
                          <td class="text-dark"><?php echo $row['note'];?></td>
                          <td><label class="badge badge-light"><?php echo $row['starttime'];?></td> <td><label class="badge badge-light"><?php echo $row['endtime'];?></td>
